            ...
            <div class="col-md-6">
                <div class="image-about-h4-wrap relative">
                    <div class="image-about-item relative about-wrap-left">
                        <img src="{{asset('vitour/assets/images/about-us/about-h41.jpg')}}" alt="image">
                        <img src="{{asset('vitour/assets/images/page/shape5.1.png')}}" alt="image" class="shape-about-h4">
                        <span class="quote">25,000 + Customer Worldwide</span>

                    </div>
                    <div class="image-about-item relative about-wrap-right">
                        <img src="{{asset('vitour/assets/images/about-us/about-h4.jpg')}}" alt="image">
                        <img src="{{asset('vitour/assets/images/page/shape5.1.png')}}" alt="image" class="shape-about-h4">
            ...
            <div class="col-md-6 inner-content-about">
                ...
                <div class="flex-three btn-wrap-about ">
                    ...
                    <div class="profile flex-three">
                        <div class="image">
                            <img src="{{asset('vitour/assets/images/avata/10.jpg')}}" alt="">
                        </div>
                        <div class="content">
                            <img src="{{asset('vitour/assets/images/page/name.png')}}" alt="">
                        ...
                        <div class="swiper-slide">
                            <div class="tour-listing box-sd">
                                <a href="tour-single.html" class="tour-listing-image">
                                    ...
                                    <img src="{{asset('vitour/assets/images/travel-list/1.jpg')}}" alt="Image Listing">
                        ...
                        <div class="swiper-slide">
                            <div class="tour-listing box-sd">
                                <a href="tour-single.html" class="tour-listing-image">
                                    ...
                                    <img src="{{asset('vitour/assets/images/travel-list/2.jpg')}}" alt="Image Listing">
                        ...
                        <div class="swiper-slide">
                            <div class="tour-listing box-sd">
                                <a href="tour-single.html" class="tour-listing-image">
                                    ...
                                    <img src="{{asset('vitour/assets/images/travel-list/3.jpg')}}" alt="Image Listing">
                        ...
                        <div class="swiper-slide">
                            <div class="tour-listing box-sd">
                                <a href="tour-single.html" class="tour-listing-image">
                                    ...
                                    <img src="{{asset('vitour/assets/images/travel-list/4.jpg')}}" alt="Image Listing">
                        ...
                        <div class="swiper-slide">
                            <div class="tour-listing box-sd">
                                <a href="tour-single.html" class="tour-listing-image">
                                    ...
                                    <img src="{{asset('vitour/assets/images/travel-list/5.jpg')}}" alt="Image Listing">
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <div class="tf-counter center tf-countto">
                    ...
                    <p class="title-counter text-white">Happy <br>Traveller</p>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="tf-counter center tf-countto">
                    ...
                    <span class="line"></span>
                    <p class="title-counter text-white">Total Postive<br>Reviews</p>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="tf-counter center tf-countto">
                    ...
                    <span class="line"></span>
                    <p class="title-counter text-white">Tour<br>Completed</p>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="tf-counter center tf-countto">
                    ...
                    <div class="number-counter number" data-to="5489" data-speed="2000"
                        data-waypoint-active="yes">5489</div>
                    <span class="line"></span>
                    <p class="title-counter text-white">Awwards<br>Winning</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="instagram-post-grid">
                    <a href="#" class="tf-instagram relative overflow-hidden">
                        <img src="{{asset('vitour/assets/images/gallery/8.jpg')}}" alt="Image Instagram">
                    ...
                    <a href="#" class="tf-instagram relative overflow-hidden">
                        <img src="{{asset('vitour/assets/images/gallery/9.jpg')}}" alt="Image Instagram">
                        <div class="mask-absolute">
                            <i class="icon-8"></i>
                        </div>
                        <div class="mask-bg">
                    ...
                    <a href="#" class="tf-instagram relative overflow-hidden">
                        <img src="{{asset('vitour/assets/images/gallery/10.jpg')}}" alt="Image Instagram">
                        <div class="mask-absolute">
                            <i class="icon-8"></i>
                        </div>
                        <div class="mask-bg">
                    ...
                    <a href="#" class="tf-instagram relative overflow-hidden">
                        <img src="{{asset('vitour/assets/images/gallery/11.jpg')}}" alt="Image Instagram">
                        <div class="mask-absolute">
                            <i class="icon-8"></i>
                        </div>
                        <div class="mask-bg">
                    ...
                    <a href="#" class="tf-instagram relative overflow-hidden">
                        <img src="{{asset('vitour/assets/images/gallery/12.jpg')}}" alt="Image Instagram">
                        <div class="mask-absolute">
                            <i class="icon-8"></i>
                        </div>
                        <div class="mask-bg">
