<header class="main-header flex">
    ...
    <div id="header">
        ...
        <div class="header-lower">
                    ...
                    <div class="col-lg-12">
                        <div class="inner-container flex justify-space align-center">
                            ...
                            <div class="logo-box">
                                <div class="logo">
                                    <a href="index.html">
                                        <img src="{{asset('vitour/assets/images/logo.png')}}" alt="Logo">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div class="navbar-collapse collapse clearfix"
                                        ...
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class="dropdown2 current">
                                                <a href="#">Tour</a>
                                                <ul>
                                                    <li class="current"><a href="{{route('liste')}}">Tour
                                                            package </a>
            ...
            <img src="{{asset('vitour/assets/images/page/fl1.png')}}" alt="" class="fly-ab">
        </div>
    </div>
